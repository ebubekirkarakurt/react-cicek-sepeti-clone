...
export default function BasketList() {
    ...
    const cartList = useAppSelector((state: RootState) => state.cartCounter.cartList);
            ...
            {cartList.map((nestedArray: any, index: number) => (
                <div key={index}>
                    ...
                    <div className="basket-detail">
                        <div id="total-price">
                            <p style={{fontSize:22,color:'black', paddingLeft:10}}>Toplam Fiyat:</p>
                            <p style={{ fontSize: 22, color: 'green', paddingLeft: 10 }}>{totalPrice()}₺</p>
                        </div>
