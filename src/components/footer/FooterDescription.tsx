  ...
  return (
    <div className="footer-desc">
      <p className="footer-desc-text">
        Türkiyenin en büyük online çiçek sitesi ÇiçekBahçem ile sevdiklerinizi
        mutlu etmek çok kolay! Çiçek göndermenin ve “Mutlu etmenin adresi”
        ÇiçekBahçem ile sevdiklerinize özel günlerde online çiçek
      ...
      <p className="footer-desc-str-text">
        <strong>
          Bu bir test sitesidir! Hiç bir şekilde bir kuruma rakip olarak açılmış
          bir site olmamakla beraber, hiç bir şekilde ticari amacı yoktur.
        </strong>
      </p>
    </div>
  );
